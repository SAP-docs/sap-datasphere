...
The *Import Entities* wizard allows you to import entities from SAP S/4HANA Cloud with rich metadata and all their sources and dependencies \(see [Import Semantically-Rich Entities from SAP BW Bridge and SAP S/4HANA Cloud](import-semantically-rich-entities-from-sap-bw-bridge-and-sap-s-4-845fedb.md)\).
...
SAP BW bridge enables you to use SAP BW functionality in the public cloud and to import SAP BW bridge data models into SAP Datasphere \(see [Using SAP Datasphere, SAP BW Bridge in SAP Datasphere](https://help.sap.com/viewer/07fda46007d24ff7b8af36b26f9b9634/cloud/en-US/b2a2df3c588849a494295aff0aa698a0.html "SAP Datasphere, SAP BW bridge enables you to use SAP BW functionality in the public cloud, to convert SAP BW∕4HANA and SAP BW models into SAP BW bridge models, and to import SAP BW bridge models into SAP Datasphere.") :arrow_upper_right:\).

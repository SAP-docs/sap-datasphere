...
6.  Navigate to the appropriate objects to review data access:
    ...
    -   *Replication Flow to Local Tables* - Open the replication flow and run it \(or create a schedule\) to replicate the data \(see  <?sap-ot O2O class="- topic/xref " href="5b591d4998fa4a148750016a29ada91e.xml" text="" desc="" xtrc="xref:11" xtrf="file:/home/builder/src/dita-all/znj1755614851492/loioc25299a38b6448f889a43b42c9e5897d_en-US/src/content/localization/en-us/59d4d341bbdb40d2877c8b8b3eaf864e.xml" output-class="" outputTopicFile="file:/home/builder/tp.net.sf.dita-ot/2.3/plugins/com.elovirta.dita.markdown_1.3.0/xsl/dita2markdownImpl.xsl" ?> \).

...
3.  Complete the properties of the input parameter:
    ...
    Specify the type of data that the input parameter will contain \(see [Column Data Types](column-data-types-7b1dc6e.md)\), and which should be appropriate for the contexts in which it will be used. Some data types require you to specific a length and or precision.

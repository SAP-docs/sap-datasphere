...
> ### Caution:  
> Before adding a SAP BW Bridge process chain to a task chain, you need to have the OpenID Authentication in your SAP BW bridge tenant configured, otherwise there will be error messages appearing when trying to drag and drop a process chain into a task chain in the task chain editor. For the detailed procedure how to configure the OpenID Authentication and resolve any error messages that might appear, see [Configure OpenID Connect (OIDC) Authentication for SAP BW Bridge](https://help.sap.com/viewer/ecce5bb08ae24ed089497fc00c2320d8/cloud/en-US/c071f0cee1f2451aa2ffedfc1a92546a.html "The OpenID Connect (OIDC) authentication for SAP BW bridge refers to the use of the OpenID Connect (OIDC) protocol as a secure and standardized method to authenticate users accessing SAP BW bridge within SAP Datasphere.") :arrow_upper_right:.

...
<a name="loiodac31a5e96cb41cf98383668d01d22cc__prereq_ivz_1cb_xgc"/>

## Prerequisites

To pause real-time replication, you must have a global role that grants you the following privileges:

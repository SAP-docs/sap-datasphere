...
-   A *Technical User* purpose:
    ...
    -   To use the `datasphere` command line interface \(`marketplace` and `tasks` commands only\). See [Manage the Data Marketplace via the Command Line](https://help.sap.com/viewer/d0ecd6f297ac40249072a44df0549c1a/cloud/en-US/5a815f6c21e9468eb96d0be95b9d2def.html "Users with a modeler role can use the datasphere command line interface to manage the Data Marketplace.") :arrow_upper_right: and [Manage Tasks and Task Chains via the Command Line](https://help.sap.com/viewer/d0ecd6f297ac40249072a44df0549c1a/cloud/en-US/2b26a31f197444dea314495bc0008eae.html "Users with an integrator role can use the datasphere command line interface to control and manage tasks and task chains.") :arrow_upper_right:\).

...
-   A *Technical User* purpose:
    ...
    -   To run schedules \(see [Manage Tasks Using REST APIs](https://help.sap.com/viewer/c8a54ee704e94e15926551293243fd1d/cloud/en-US/274f2736465c4c48a091c675880502a2.html "You can run task chains and review task logs using REST APIs.") :arrow_upper_right:\).

...
4.  To change the priority or statement limits of a group, click it and change the settings as follows:
    ...
    *Total Statement Thread Limit*
    ...
    > ### Note:  
    > 100% represents the maximum of 80% of CPU resources reserved for workload generated by groups, user group users and agent users. The remaining 20% of CPU resources are reserved to ensure that the system can respond under heavy load.

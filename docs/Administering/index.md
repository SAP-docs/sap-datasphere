...
-   [Creating and Configuring Your SAP Datasphere Tenant](Creating-and-Configuring-Your-Tenant/creating-and-configuring-your-sap-datasphere-tenant-2f80b57.md)
    ...
    -   [Enable Choropleth Layers for Geographical Visualizations](Creating-and-Configuring-Your-Tenant/enable-choropleth-layers-for-geographical-visualizations-4e45d4c.md)
    ...
    -   [Restart Your SAP HANA Database](Creating-and-Configuring-Your-Tenant/restart-your-sap-hana-database-9e7a761.md)
-   [Managing Users and Roles](Managing-Users-and-Roles/managing-users-and-roles-903b75e.md)
    -   [Configuring Identity Provider SettingsManaging User Identity and Authentication](Managing-Users-and-Roles/configuring-identity-provider-settingsmanaging-user-identity-and-authentication-48b5c8b.md)
        ...
        -   [Identity Provider AdministrationAccess the Identity Provider Administration Tool](Managing-Users-and-Roles/identity-provider-administrationaccess-the-identity-provider-administration-tool-df15ed8.md)
        -   [Enabling a Custom SAML Identity Provider \(Legacy Custom IdP\)](Managing-Users-and-Roles/enabling-a-custom-saml-identity-provider-legacy-custom-idp-9b26536.md)
            -   [Renewing the SAP Analytics Cloud SAML Signing Certificate](Managing-Users-and-Roles/renewing-the-sap-analytics-cloud-saml-signing-certificate-0cfc214.md)
            -   [Updating the SAML IdP Signing CertificateUpdate SAML Signing Certificates \(Legacy Custom IdP\)](Managing-Users-and-Roles/updating-the-saml-idp-signing-certificateupdate-saml-signing-certificates-legacy-custom-ba968db.md)
            ...
            -   [Disabling SAML SSORevert to Default Authentication \(Legacy Custom IdP\)](Managing-Users-and-Roles/disabling-saml-ssorevert-to-default-authentication-legacy-custom-idp-8c37db7.md)
    -   [Managing SAP Datasphere Users](Managing-Users-and-Roles/managing-sap-datasphere-users-4fb82cb.md)
        -   [Search, Sort and Filter in the Users Page](Managing-Users-and-Roles/search-sort-and-filter-in-the-users-page-bd2b776.md)
        ...
        -   [Delete a User](Managing-Users-and-Roles/delete-a-user-3ceb94c.md)
    ...
    -   [Managing Roles and Privileges](Managing-Users-and-Roles/managing-roles-and-privileges-3740dac.md)
        -   [Search, Sort and Filter in the Roles Page](Managing-Users-and-Roles/search-sort-and-filter-in-the-roles-page-b5637df.md)
        -   [Standard Application RolesStandard Roles Delivered with SAP Datasphere](Managing-Users-and-Roles/standard-application-rolesstandard-roles-delivered-with-sap-datasphere-a50a51d.md)
        -   [Privileges and Permissions](Managing-Users-and-Roles/privileges-and-permissions-d7350c6.md)
        -   [Privileges by App, Tool, Object, and Task](Managing-Users-and-Roles/privileges-by-app-tool-object-and-task-2d8b7d0.md)
        ...
        -   [Assign Roles to UsersAssign Users to a Role](Managing-Users-and-Roles/assign-roles-to-usersassign-users-to-a-role-57a7880.md)
        ...
        -   [Managing Users via the SCIM 2.0 API](Managing-Users-and-Roles/managing-users-via-the-scim-2-0-api-1ca8c4a.md)
...
-   [Preparing Connectivity for Connections](Preparing-Connectivity/preparing-connectivity-for-connections-bffbd58.md)
    ...
    -   [Preparing SAP BW∕4HANA Model Transfer Connectivity](Preparing-Connectivity/preparing-sap-bw-4hana-model-transfer-connectivity-962de2f.md)
        ...
        -   [Available Source Versions for SAP BW∕4HANA Model Transfer Connections](Preparing-Connectivity/available-source-versions-for-sap-bw-4hana-model-transfer-connections-4aefe38.md)
    ...
    -   [Prepare Connectivity to SAP S/4HANA Cloud](Preparing-Connectivity/prepare-connectivity-to-sap-s-4hana-cloud-abb159e.md)
        -   [Using ABAP SQL Services for Accessing Data from SAP S/4HANA Cloud or SAP BTP ABAP Environment](Preparing-Connectivity/using-abap-sql-services-for-accessing-data-from-sap-s-4hana-cloud-or-sap-btp-abap-environ-ef2b223.md)
    -   [Prepare Connectivity to SAP S/4HANA On-Premise](Preparing-Connectivity/prepare-connectivity-to-sap-s-4hana-on-premise-8de01dd.md)
        ...
        -   [Configure OAuth 2.0 Client Credentials for SAP ABAP and SAP S/4HANA Connections](Preparing-Connectivity/configure-oauth-2-0-client-credentials-for-sap-abap-and-sap-s-4hana-connections-03dde85.md)
...
-   [Monitoring SAP Datasphere](monitoring-sap-datasphere-d39b865.md)
    ...
    -   [Monitoring Elastic Compute Nodes](monitoring-elastic-compute-nodes-1d5f583.md)
    -   [Configure Monitoring](configure-monitoring-9cd0691.md)
        -   [Working with SAP HANA Monitoring Views](working-with-sap-hana-monitoring-views-4ab4509.md)
    ...
    -   [Create a Database Analysis User to Debug Database Issues](create-a-database-analysis-user-to-debug-database-issues-c28145b.md)
        -   [Manage Database Analysis Users](manage-database-analysis-users-4bb6d37.md)
        -   [Stop a Running Statement With a Database Analysis User](stop-a-running-statement-with-a-database-analysis-user-0cf11ed.md)
    -   [Configure Notifications](configure-notifications-4388411.md)
    -   [Manage Tenant Disk Storage](manage-tenant-disk-storage-27d4c68.md)

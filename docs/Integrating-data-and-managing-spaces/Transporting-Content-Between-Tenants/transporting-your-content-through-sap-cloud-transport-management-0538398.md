...
> 
> The authentication method \(defined by the tenant owner\) must be the same on the source and on the target tenant. If the selected method is single sign-on \(SSO\), make sure to define the same user attribute for the source and the target tenant. For more information on authentication methods, see [Managing User Identity and Authentication](https://help.sap.com/viewer/935116dd7c324355803d4b85809cec97/DEV_CURRENT/en-US/48b5c8b637a54fa491594272941855b9.html "Choose how to manage user identity and authentication for your SAP Datasphere tenant.") :arrow_upper_right:.

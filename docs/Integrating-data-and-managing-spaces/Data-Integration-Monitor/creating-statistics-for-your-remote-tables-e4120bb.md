...
To ensure the best possible performance when accessing your remote tables and provide efficient query execution plans, you can create statistics for your remote tables. SAP Datasphere uses the SAP HANA SQL Optimizer that relies on accurate data statistics for virtual tables in SAP HANA and helps SAP HANA SQL Optimizer to take decisions. For more info, see [SAP HANA SQL Optimizer](https://help.sap.com/viewer/9de0171a6027400bb3b9bee385222eff/latest/en-US/d2948cc2209a407ea2b686c29e72ca50.html).

When you generate statistics from the *Remote Queries* monitor, SAP Datasphere sends a request to the SAP HANA database. SAP HANA then creates the corresponding statistics and stores them in its catalog. You can then access these statistics either by querying the system view called [DATA\_STATISTICS](https://help.sap.com/docs/hana-cloud-database/sap-hana-cloud-sap-hana-database-sql-reference-guide/data-statistics-system-view?version=LATEST&locale=en-US) , which can be queried using a [DB Analysis User](https://help.sap.com/docs/SAP_DATASPHERE/9f804b8efa8043539289f42f372c4862/c28145bcb76c4415a1ec6265dd2a4c11.html?locale=en-US&version=LATEST), or - preferably - by reading the monitoring view [M\_DATA\_STATISTICS](https://help.sap.com/docs/hana-cloud-database/sap-hana-cloud-sap-hana-database-sql-reference-guide/m-data-statistics-system-view?version=LATEST&locale=en-US) using a database UI tool such as DB Explorer.

...
-   You can change the run mode of your data persistence and choose between performance and memory consumptions. For more information, see [Change Persisted View Settings](change-persisted-view-settings-d04f5dd.md).

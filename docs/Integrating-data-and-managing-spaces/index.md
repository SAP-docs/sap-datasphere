...
-   [Working with SAP Datasphere in SAP Business Data Cloud](working-with-sap-datasphere-in-sap-business-data-cloud-8f9c372.md)
    -   [Installing Intelligent Content](installing-intelligent-content-344999c.md)
        ...
        -   [Applying Row-Level Security to Data Delivered through Intelligent Content](applying-row-level-security-to-data-delivered-through-intelligent-content-c83225f.md)
        -   [Extending Intelligent Applications](extending-intelligent-applications-3c15868.md)
        -   [Partitioning Local Tables for Intelligent Applications](partitioning-local-tables-for-intelligent-applications-07d9768.md)
    ...
    -   [Creating Data Products](creating-data-products-ebe9dc0.md)
        -   [Integrating Data from SAP BW and SAP BW∕4HANA with the Data Product Generator for SAP Business Data Cloud](integrating-data-from-sap-bw-and-sap-bw-4hana-with-the-data-product-generator-for-sap-bus-cca4744.md)
    ...
    -   [Ingestion Spaces and Other SAP Business Data Cloud Spaces](ingestion-spaces-and-other-sap-business-data-cloud-spaces-8390855.md)
-   [Integrating Data via Connections](Integrating-Data-Via-Connections/integrating-data-via-connections-eb85e15.md)
    ...
    -   [Connection Types](Integrating-Data-Via-Connections/connection-types-9456242.md)
        ...
        -   [Business Data Product Connections](Integrating-Data-Via-Connections/business-data-product-connections-5661d88.md)
        -   [Confluent Connections](Integrating-Data-Via-Connections/confluent-connections-d83c08a.md#loiod83c08ad4eaf49dba9602b1d51c07a52)
            -   [Configuring Connection Properties For Confluent Platform](Integrating-Data-Via-Connections/confluent-connections-d83c08a.md#loioa5d1e1d2885f4a69ae3cc5049eb0cabf)
            -   [Configuring Connection Properties For Confluent Cloud](Integrating-Data-Via-Connections/confluent-connections-d83c08a.md#loio8cd75f509baf41bdb859fd2efa045c84)
        -   [Cloud Data Integration Connections](Integrating-Data-Via-Connections/cloud-data-integration-connections-cd33107.md)
        -   [Generic HTTP Connections](Integrating-Data-Via-Connections/generic-http-connections-b79b865.md)
        ...
        -   [Microsoft OneLake Connections](Integrating-Data-Via-Connections/microsoft-onelake-connections-057fa4b.md)
        ...
        -   [SAP Signavio Connections](Integrating-Data-Via-Connections/sap-signavio-connections-4c367de.md)
...
-   [Integrating Data via Database Users/Open SQL Schemas](Integrating-Data-Via-Database-Users/Open-SQL-Schema/integrating-data-via-database-users-open-sql-schemas-3de55a7.md)
    ...
    -   [Allow the Space to Access the Open SQL Schema](Integrating-Data-Via-Database-Users/Open-SQL-Schema/allow-the-space-to-access-the-open-sql-schema-7eaa370.md)
-   [Exchanging Data with SAP HANA for SQL Data Warehousing HDI Containers](Exchanging-Data-with-SAP-SQL-Data-Warehousing-HDI-Container/exchanging-data-with-sap-hana-for-sql-data-warehousin-1aec7ca.md)
...
-   [Managing and Monitoring Data Integration](Data-Integration-Monitor/managing-and-monitoring-data-integration-4cbf7c7.md)
    ...
    -   [Data Pipeline Analyzer](Data-Integration-Monitor/data-pipeline-analyzer-54fd00d.md)
    ...
    -   [Persisting and Monitoring Views](Data-Integration-Monitor/persisting-and-monitoring-views-9af04c9.md)
        -   [Change Persisted View Settings](Data-Integration-Monitor/change-persisted-view-settings-d04f5dd.md)
    ...
    -   [Monitoring Flows](Data-Integration-Monitor/monitoring-flows-b661ea0.md)
        ...
        -   [Transformation Flows and Memory Consumption](Data-Integration-Monitor/transformation-flows-and-memory-consumption-b266bf4.md)
        -   [Override the Default Settings to Run Your Transformation Flow \(in a File Space\)](Data-Integration-Monitor/override-the-default-settings-to-run-your-transformation-flow-in-a-file-space-e5c4ac8.md)
    ...
    -   [Scheduling Data Integration Tasks](Data-Integration-Monitor/scheduling-data-integration-tasks-7fa0762.md)
        ...
        -   [Modify the Owner of a Schedule](Data-Integration-Monitor/modify-the-owner-of-a-schedule-4b660c0.md)
...
-   [Securing Data with Data Access Controls](Data-Access-Control/securing-data-with-data-access-controls-a032e51.md)
    ...
    -   [Create a "Hierarchy with Directory" Data Access Control](Data-Access-Control/create-a-hierarchy-with-directory-data-access-control-44ae628.md)
    -   [Use Identity Provider Attributes as Identifiers in Data Access Controls](Data-Access-Control/use-identity-provider-attributes-as-identifiers-in-data-access-controls-40f493f.md)
...
-   [Managing Your Space](managing-your-space-268ea7e.md)
    -   [Assign Members to Your SpaceControl User Access to Your Space](assign-members-to-your-spacecontrol-user-access-to-your-space-9d59fe5.md)
    -   [Create Time Data and Dimensions](create-time-data-and-dimensions-c5cfce4.md)
    -   [Logging Read and Change Actions for Audit](logging-read-and-change-actions-for-audit-2665539.md)
    -   [Translating Metadata for SAP Analytics Cloud](translating-metadata-for-sap-analytics-cloud-fe829de.md)
    ...
    -   [Unlock a Locked Space](unlock-a-locked-space-c05b6a6.md)

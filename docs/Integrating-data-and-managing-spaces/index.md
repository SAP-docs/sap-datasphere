...
-   [Integrating Data from SAP Business Data Cloud](integrating-data-from-sap-business-data-cloud-8f9c372.md)
    -   [Reviewing Installed Insight Apps](reviewing-installed-insight-apps-6446487.md)
    -   [Applying Row-Level Security to Data Delivered through Insight Apps](applying-row-level-security-to-data-delivered-through-insight-apps-c83225f.md)
    -   [Extending Insight Apps](extending-insight-apps-3c15868.md)

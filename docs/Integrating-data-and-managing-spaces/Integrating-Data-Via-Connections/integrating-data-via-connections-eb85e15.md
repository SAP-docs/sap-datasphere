...
<span class="FPA-icons-V3"></span> \(Add Connection\) ** \> *Add Connection to System in Unified Customer Landscape*

</td>
<td valign="top">

Add a connection which has been generated by a Unified Customer Landscape formation to the space and allow users assigned to the space to use the connected remote system for data modeling and data access in SAP Datasphere.

For more information, see [Add a Connection to a System in Unified Customer Landscape to the Space](add-a-connection-to-a-system-in-unified-customer-landscape-to-the-space-2629b2e.md).

...
Use the connection to access data from SAP Marketing Cloud via its OData-based APIs for data integration and SAP HANA Smart Data Integration.
...
See: [Prepare Connectivity to SAP Marketing Cloud](https://help.sap.com/viewer/935116dd7c324355803d4b85809cec97/internal/en-US/f5e0c06fdc834c62a10eeb19d9a79bab.html "To be able to successfully validate and use a connection to SAP Marketing Cloud for remote tables or data flows, certain preparations have to be made.") :arrow_upper_right:

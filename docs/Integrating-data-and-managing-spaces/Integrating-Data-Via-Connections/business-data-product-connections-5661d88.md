...
[Working with SAP Datasphere in SAP Business Data Cloud](../working-with-sap-datasphere-in-sap-business-data-cloud-8f9c372.md "Users with an SAP Business Data Cloud administrator role can install intelligent applications to SAP Datasphere and activate data packages to allow modelers to work with data products.")

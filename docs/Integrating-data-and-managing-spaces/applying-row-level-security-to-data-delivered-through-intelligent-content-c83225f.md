...
# Applying Row-Level Security to Data Delivered through Intelligent Content

All intelligent content delivered through SAP Business Data Cloud are secured in SAP Datasphere through data access controls. By default, no user can view any data presented in the provided SAP Analytics Cloud stories. To make data available to the users authorized to see it in SAP Datasphere, you must upload your authorizations to the provided permissions table.
